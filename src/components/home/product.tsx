...
import { fetchAll } from "@/app/api/fetchAll";
...
const Product: React.FC<ProductProps> = ({ onAddToCart }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center w-full  pt-14 sm:pt-24 font-montserrat">
      <p className="text-2xl text-center font-montserrat font-semibold p">
        New Arrivals
      </p>
      <p className="text-slate-400 text-center text-base sm:text-lg pt-1 px-10">
