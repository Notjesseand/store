  ...
  return (
    <div>
      ...
      <div className="w-4/5 mx-auto  text-center justify-center pt-2">
        <Link
          href={`/products/${product.id}`}
          className="text-center flex  justify-center text-sm lg:text-xs sm:text-base hover:text-orange-600"
        >
          {product.title.length > 20
            ? product.title.slice(0, 24) + "..."
            : product.title}
        </Link>
        <p className="text-center flex text-sm lg-text-xs justify-center mt-2">
